	...
	<table border="5" bordercolor="#008CBA" align="center" cellpadding="25px"  style= " color:#008CBA; border-collapse: collapse;font-size: 18px " >
			...
			<tr>
				...
				<%
					try {
						...
						String sql = "select * from orders where preapredEID is not null and diliverEID is null";
			...
			<tr>
				...
				<td align="center"><%=db.rs.getString("paymentType")%></td>
					...
					<td align="center"><%=db.rs.getString("diliver")%></td>
				<td align="center"><%=db.rs.getString("preapredEID")%></td>
					<td> <input type="text" name="diliverEID"></td>
					<input type="hidden" name="OrderID" value="<%=db.rs.getString("OrderID")%>">OrderID
